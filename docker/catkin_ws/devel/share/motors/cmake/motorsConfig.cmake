...
if("TRUE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /catkin_ws/src/motors)
  set(motors_DEVEL_PREFIX /catkin_ws/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT "/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/motors/${idir}'.  ${_report}")
    endif()
...
set(motors_EXPORTED_TARGETS "motors_generate_messages_cpp;motors_generate_messages_eus;motors_generate_messages_lisp;motors_generate_messages_nodejs;motors_generate_messages_py")
