...
class FPID_controller ():   
    def __init__(self, motor=[], Kf=0., Kp=1., Ki=0., Kd=0., error_integral_limit=np.inf, integral_resetting = True, motor_command_max_rate_of_change=100., motor_command_max=1., forward_motor_command_sign=1): 
        self.motor = motor
        self.Kf = Kf
        self.Kp = Kp
        self.Ki = Ki
